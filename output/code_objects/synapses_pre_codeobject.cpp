...
double* const _array_synapses_w_ei = _dynamic_array_synapses_w_ei.empty()? 0 : &_dynamic_array_synapses_w_ei[0];
const size_t _numw_ei = _dynamic_array_synapses_w_ei.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_synapses_w_ei = _array_synapses_w_ei;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double g_e_post = _ptr_array_neurongroup_1_g_e[_postsynaptic_idx];
            const double w_ei = _ptr_array_synapses_w_ei[_idx];
            g_e_post += w_ei;
            _ptr_array_neurongroup_1_g_e[_postsynaptic_idx] = g_e_post;
