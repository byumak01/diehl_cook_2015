...
const size_t _numg_i_post = 400;
double* const _array_synapses_1_w_ie = _dynamic_array_synapses_1_w_ie.empty()? 0 : &_dynamic_array_synapses_1_w_ie[0];
const size_t _numw_ie = _dynamic_array_synapses_1_w_ie.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_1__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_synapses_1_w_ie = _array_synapses_1_w_ie;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double g_i_post = _ptr_array_neurongroup_g_i[_postsynaptic_idx];
            const double w_ie = _ptr_array_synapses_1_w_ie[_idx];
            g_i_post += w_ie;
            _ptr_array_neurongroup_g_i[_postsynaptic_idx] = g_i_post;
