...
void _run_neurongroup_1_stateupdater_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const double E_exc_for_inh = 0.0;
const double E_inh_for_inh = - 0.085;
const double E_rest_inh = - 0.06;
const int64_t N = 400;
...
const double tau_lif_inh = 0.01;
const size_t _numv = 400;
    ///// POINTERS ////////////
        
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_neurongroup_1_g_e = _array_neurongroup_1_g_e;
    double* __restrict  _ptr_array_neurongroup_1_g_i = _array_neurongroup_1_g_i;
    ...
    const double _lio_4 = 1.0f*dt/tau_lif_inh;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double g_e = _ptr_array_neurongroup_1_g_e[_idx];
        double g_i = _ptr_array_neurongroup_1_g_i[_idx];
        ...
        if(!not_refractory)
            ...
            _v = (_lio_4 * ((E_rest_inh + ((g_e * (E_exc_for_inh - v)) + (g_i * (E_inh_for_inh - v)))) - v)) + v;
        g_e = _g_e;
        g_i = _g_i;
        if(not_refractory)
            v = _v;
        _ptr_array_neurongroup_1_g_e[_idx] = g_e;
        _ptr_array_neurongroup_1_g_i[_idx] = g_i;
