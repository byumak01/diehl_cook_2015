...
const int64_t _target_offset = 0;
    ...
    _dynamic_array_synapses_2_Apost1_ee.resize(newsize);
    _dynamic_array_synapses_2_Apost2_ee.resize(newsize);
    _dynamic_array_synapses_2_Apost2_prev_ee.resize(newsize);
    _dynamic_array_synapses_2_Apre_ee.resize(newsize);
    ...
    _dynamic_array_synapses_2_w_ee.resize(newsize);
