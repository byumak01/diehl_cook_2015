...
double* const _array_synapses_2_Apost2_prev_ee = _dynamic_array_synapses_2_Apost2_prev_ee.empty()? 0 : &_dynamic_array_synapses_2_Apost2_prev_ee[0];
const size_t _numApost2_prev_ee = _dynamic_array_synapses_2_Apost2_prev_ee.size();
...
const int64_t w_min_ee = 0;
    ...
    double* __restrict  _ptr_array_synapses_2_Apost2_prev_ee = _array_synapses_2_Apost2_prev_ee;
        ...
        _spiking_synapse_idx++)
    {
        ...
        double Apost2_prev_ee = _ptr_array_synapses_2_Apost2_prev_ee[_idx];
        ...
        w_ee = _clip(w_ee + (eta_post_ee * (Apre_ee * Apost2_prev_ee)), w_min_ee, w_max_ee);
        Apost1_ee = 1;
        Apost2_ee = 1;
        lastupdate = t;
        _ptr_array_synapses_2_Apost1_ee[_idx] = Apost1_ee;
        _ptr_array_synapses_2_Apost2_ee[_idx] = Apost2_ee;
        _ptr_array_synapses_2_Apost2_prev_ee[_idx] = Apost2_prev_ee;
